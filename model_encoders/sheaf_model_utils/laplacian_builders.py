...
from model_encoders.sheaf_model_utils.orthogonal import Orthogonal
from model_encoders.sheaf_model_utils.lib import laplace as lap
...
class LaplacianBuilder(nn.Module):
    ...
    def create_with_new_edge_index(self, edge_index):
        ...
        new_builder = self.__class__(
            ...
            augmented=self.augmented)  # No precomputed indices for new edge index
...
class NormConnectionLaplacianBuilder(LaplacianBuilder):
    ...
    def create_with_new_edge_index(self, edge_index):
        ...
        new_builder = self.__class__(
            ...
            orth_map=self.orth_map)  # No precomputed indices for new edge index
        new_builder.train(self.training)
        return new_builder
