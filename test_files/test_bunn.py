...
def create_bunn_for_node_classification(
    input_dim: int,
    num_classes: int,
    hidden_dim: int = 64,
    num_layers: int = 2,
    ...
    **kwargs
    ...
    """Create BuNN for node classification."""
    return BuNN(
        input_dim=input_dim,
        hidden_dim=hidden_dim,
...
def create_bunn_for_graph_classification(
    input_dim: int,
    num_classes: int,
    hidden_dim: int = 64,
    num_layers: int = 3,
    ...
    **kwargs
    ...
    """Create BuNN for graph classification."""
    return BuNN(
        input_dim=input_dim,
        hidden_dim=hidden_dim,
        output_dim=num_classes,
